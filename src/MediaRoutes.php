...
class MediaRoutes
{
    public function __construct()
    {
        Route::group([
            ...
            Route::any('files', ['uses' => '\ctf0\MediaManager\Controllers\MediaController@files', 'as' => 'files']);
            Route::any('directories', ['uses' => '\ctf0\MediaManager\Controllers\MediaController@get_all_dirs', 'as' => 'directories']);
